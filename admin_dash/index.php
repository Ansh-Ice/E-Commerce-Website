    ...
    <div id="main-content" class="container allContent-section py-4">
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="card">
                    ...
                    <h4 style="color:white;">Total Vendors</h4>
                    <h5 style="color:white;">
                    <?php
        ...
        <?php
            ...
            if (isset($_GET['subscription']) && $_GET['subscription'] == "success") {
                echo '<script> alert("Subscription Successfully Added")</script>';
            }else if (isset($_GET['subscription']) && $_GET['subscription'] == "error") {
                echo '<script> alert("Subscription Adding Unsuccess")</script>';
            }
            if (isset($_GET['vendor']) && $_GET['vendor'] == "success") {
                echo '<script> alert("vendor Successfully Added")</script>';
            }else if (isset($_GET['vendor']) && $_GET['vendor'] == "error") {
                echo '<script> alert("Adding Unsuccess")</script>';
            }
            ...
            if (isset($_GET['admin']) && $_GET['admin'] == "success") {
                ...
                echo '<script> alert("Admin Adding Unsuccess")</script>';
            }
            if (isset($_GET['material']) && $_GET['material'] == "success") {
                echo '<script> alert("Material Successfully Added")</script>';
            }else if (isset($_GET['material']) && $_GET['material'] == "error") {
                echo '<script> alert("Material Adding Unsuccess")</script>';
            }
        ?>
